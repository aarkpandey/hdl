...
localparam REG_TRANSFER_LENGTH = 2'b10;
...
wire first_bit;
reg last_transfer;
reg [7:0] transfer_length = DATA_WIDTH;
wire end_of_word;

assign first_bit = bit_counter == 'h0;
assign last_bit = bit_counter == transfer_length - 1;
        ...
        if (resetn == 1'b0) begin
                ...
                transfer_length <= DATA_WIDTH;
                 ...
                 if (cmd[9:8] == REG_CONFIG) begin
                        ...
                        clk_div <= cmd[7:0];
                end else if (cmd[9:8] == REG_TRANSFER_LENGTH) begin
                        // the max value of this reg must be DATA_WIDTH
                        transfer_length <= cmd[7:0];
                end
        end
end
